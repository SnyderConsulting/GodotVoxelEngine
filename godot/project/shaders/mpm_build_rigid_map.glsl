...
// Per-cell rigid map: 0 = none, otherwise particle_index+1 for rigid materials.
layout(set = 0, binding = 5, std430) buffer RigidMap {
    uint data[];
} rigid_map;
...
void main() {
    ...
    atomicCompSwap(rigid_map.data[ci], 0u, p + 1u);
}
